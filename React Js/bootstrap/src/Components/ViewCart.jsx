...
export default function ViewCart() {
    ...
    return (
        <>
            <section class="h-100 h-custom" style={{ background: '#eee' }}>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="d-flex justify-content-between">
                                                                    <div class="d-flex flex-row align-items-center">
                                                                        ...
                                                                        <div class="ms-3">
                                                                            <h5>{v.name}</h5>
                                                                            <p class="small mb-0">{v.description}</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="d-flex flex-row align-items-center">
                                                                        <div style={{ width: '50px' }}>
                                                                            <h5 class="fw-normal mb-0">{v.quantity}</h5>
                                                                        </div>
                                                                        <div style={{ width: '80px' }}>
                                                                            <h5 class="mb-0">${v.quantity * v.price}</h5>
                                                                        </div>
