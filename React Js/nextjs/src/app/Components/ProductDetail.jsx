...
export default function ProductDetail({ id }) {
  ...
  useEffect(() => {
    axios.get(`https://wscubetech.co/ecommerce-api/productdetails.php?id=${id}`)
      .then((result) => {
          ...
          <>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
              <div class="flex flex-col md:flex-row -mx-4">
                  ...
                  <div x-data="{ image: 1 }" x-cloak>
                    <div class="h-64 md:h-80 rounded-lg bg-gray-100 mb-4">
                      <div x-show="image === 1" class="h-64 md:h-80 rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
                        <span class="text-5xl">
                          <img src={productDetails.multiple_images[0]} />
                        </span>
                      </div>
                    ...
                    <div class="flex -mx-2 mb-4">
                      <template x-for="i in 4">
                        <div class="flex-1 px-2">
                          <button class="ring-2 ring-indigo-300 ring-inset focus:outline-none w-full rounded-lg h-24 md:h-32 bg-gray-100 flex items-center justify-center">
                ...
                <div class="md:flex-1 px-4">
                  <h2 class="mb-2 leading-tight tracking-tight font-bold text-gray-800 text-2xl md:text-3xl">{productDetails.name}</h2>
